...
const Login = () => {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col'>
        ...
        <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
          ...
          <div className='h-full w-full lg:w-2/3 flex flex-col items-center justify-center'>
            <div className='w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:-mt-20'>
              <span className='flex gap-1 py-1 px-3 border rounded-full text-sm md:text-base border-gray-300 text-gray-600'>Manage all your interns tasks at one Place!</span>
              <p className='flex flex-col gap-0 md:gap-4 text-4xl md:text-6xl 2xl:text-7xl font-black text-center text-orange-500'>
                <span>Intern</span>
                <span>Manager</span>
              </p>
          ...
          <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
            <form onSubmit={handleSubmit(submitHandler)} className='form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14'>
              ...
              <div className='flex flex-col gap-y-5'>
                ...
                <span className='text-sm text-gray-500 hover:text-orange-500 hover:underline cursor-pointer'>
                  Forget Password?
                </span>
      ...
      {/* Footer */}
      <div className='w-full h-16 bg-gray-200 flex items-center justify-center px-4'>
